public class SudokoSolver {
	...
	public static boolean isValid(char[][] board, int row, int col, char c)
	{
		for(int i=0;i<9;i++)
		{
			...
			//Explaining the logic behind the normalization used in the 3*(row/3) and 3*(col/3)
			//Here let we suppose we are at (5, 7)
			//Here the row=5 and col=7
			//So, 3*(5/3) and 3*(7/3)
			//So, 3*(1) and 3*(2), (It will make cover up to the nearest whole number as by-default it will act as int)
			//So, 3 and 6 -->Which gives us the idea from which of the row and column do we have to start checking
			//So, starting of 2nd box's row and starting of starting of 3dr box's column
