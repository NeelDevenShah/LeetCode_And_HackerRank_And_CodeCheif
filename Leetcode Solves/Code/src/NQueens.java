 ...
 * 	1. (Manuall Method) Using concept of Backtracking, We will place Queen at different positions of the chess board and find the right arrangement where all the n queens can be placed on the n*n grid
 ...
 * 	2. (Hashing Method) Optimization of the upper method, We need O(N) for row, O(N) for column, and O(N) for diagonal.Here we will use hashing to maintain a list to check whether that position can be
